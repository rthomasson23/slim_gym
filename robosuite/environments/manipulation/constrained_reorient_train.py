...
class ConstrainedReorientTrain(SingleArmEnv):
    """
    ...
    def _load_model(self):
        ...
        self.placement_initializer = UniformRandomSampler(
            name="ObjectSampler",
            mujoco_objects=[self.place_object] + [self.goal_object],
            x_range=[-0.1, 0.1],
            y_range=[-.2, 0.2],
    ...
    def _reset_internal(self):
        ...
        np.random.seed(self.trial_counter + 200)
